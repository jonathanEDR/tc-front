...
const Paginacion: React.FC<Props> = memo(({ currentPage, totalPages, onPageChange, loading = false }) => {
  ...
  if (import.meta.env.DEV) {
    console.log('[Paginacion] Props:', { currentPage, totalPages, loading });
  }
            ...
            {currentPage < totalPages - 1 && (
              <>
                ...
                >
                  ...
                  <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fillRule="evenodd" d="M4.21 5.23a.75.75 0 01.02-1.06L8.168 10 4.23 13.71a.75.75 0 101.04 1.08l4.5-4.25a.75.75 0 000-1.08l-4.5-4.25a.75.75 0 01-1.06.02zm6 0a.75.75 0 01.02-1.06L14.168 10l-3.938 3.71a.75.75 0 101.04 1.08l4.5-4.25a.75.75 0 000-1.08l-4.5-4.25a.75.75 0 01-1.06.02z" clipRule="evenodd" />
                  </svg>
                </button>
              </>
            )}
